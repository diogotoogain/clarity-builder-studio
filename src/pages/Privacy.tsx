...
import { ArrowLeft, ChevronUp, Menu, X, Shield } from 'lucide-react';
import { useI18n } from '@/lib/i18n';
import { Helmet } from 'react-helmet-async';

const sections = [
  { id: 'section1', key: 'privacy.section1' },
  { id: 'section2', key: 'privacy.section2' },
  { id: 'section3', key: 'privacy.section3' },
  { id: 'section4', key: 'privacy.section4' },
  { id: 'section5', key: 'privacy.section5' },
  { id: 'section6', key: 'privacy.section6' },
  { id: 'section7', key: 'privacy.section7' },
  { id: 'section8', key: 'privacy.section8', isHighlight: true },
  { id: 'section9', key: 'privacy.section9' },
  { id: 'section10', key: 'privacy.section10' },
  { id: 'section11', key: 'privacy.section11' },
  { id: 'section12', key: 'privacy.section12' },
  { id: 'section13', key: 'privacy.section13' },
  { id: 'section14', key: 'privacy.section14' },
];
...
const Privacy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('privacy.title')} | TOOGAIN</title>
                  ...
                  {sections.map((section, index) => (
                    ...
                    >
                      <h2 className={`font-heading text-xl font-semibold mb-4 ${
                        section.isHighlight ? 'text-primary' : 'text-foreground'
                      }`}>
                        {t(`${section.key}.title`)}
                      </h2>
